...
+import { AlertManager, useAlerts } from "./components/AnimatedAlert";
 import './index.css';
 ...
 function App() {
+  const { alerts, removeAlert, showError } = useAlerts();
...
+  if (serverDown) return <ServerError />;
   ...
   return (
-    <div className="App">
+    <div className={`App ${sidebarVisible ? 'sidebar-expanded' : ''}`}>
