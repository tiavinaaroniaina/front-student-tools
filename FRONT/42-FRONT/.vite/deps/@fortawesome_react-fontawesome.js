...
var require_coerce = __commonJS({
  "../node_modules/semver/functions/coerce.js"(exports, module) {
    ...
    var coerce2 = (version, options) => {
      ...
      const build3 = options.includePrerelease && match[6] ? `+${match[6]}` : "";
      return parse2(`${major}.${minor}.${patch}${prerelease}${build3}`, options);
    };
...
var require_subset = __commonJS({
  "../node_modules/semver/ranges/subset.js"(exports, module) {
    ...
    var simpleSubset = (sub, dom2, options) => {
      if (sub === dom2) {
        return true;
      }
...
var FA_VERSION = typeof process !== "undefined" && process.env.FA_VERSION || "7.0.0";
var SVG_CORE_VERSION = package_default.version || FA_VERSION;
var IS_VERSION_7_OR_LATER = import_semver.default.gte(
  SVG_CORE_VERSION,
